      ...
      <div className="container">
        <div className="section-heading">
          ...
          <p className="section-description mt-5">
            We build powerful, intuitive websites and apps that bring your ideas to life. From seamless user experiences to cutting-edge performance, we’re here to help you scale.
          </p>
        </div>
